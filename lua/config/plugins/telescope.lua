...
M.config = {
	{
		...
		dependencies = {
			"nvim-lua/plenary.nvim",
			{
				...
				config = function()
					...
					vim.keymap.set('n', '<c-y>', tstabs.list_tabs, {})
				end
			},
		...
		config = function()
			...
			vim.keymap.set('n', '<M-w>', builtin.live_grep, m)
			-- vim.keymap.set('n', '<c-f>', function()
			-- 	builtin.grep_string({ search = "" })
			-- end, m)
			vim.keymap.set('n', '<leader>rs', builtin.resume, m)
			vim.keymap.set('n', '<c-w>', builtin.buffers, m)
			vim.keymap.set('n', '<c-m>', builtin.oldfiles, m)
			vim.keymap.set('n', '<M-s>', builtin.current_buffer_fuzzy_find, m)
			...
			-- vim.keymap.set('n', 'T', builtin.lsp_document_symbols, {})
				...
				defaults = {
					...
					mappings = {
						i = {
							...
							["<C-u>"] = "move_selection_next",
							["<M-e>"] = "preview_scrolling_up",
